...
function About() {
  return (
    <div className="p-5 mt-6 mb-6 flex justify-center items-center bg-gradient-to-r from-violet-500 to-white">
      <div className="lg:w-4/5 w-full">
        {/* Centered Heading */}
        <h1 className="text-4xl font-extrabold text-center text-blue-900 mb-6 font-sans">About Us</h1>
        ...
        <div className="lg:flex lg:flex-row gap-6 flex-col">
          ...
          <div className="lg:w-2/3 w-full">
            <div className="font-sans">
              ...
              <div className="w-full mb-4">
                <img
                  className="w-full h-auto lg:w-auto lg:h-auto rounded-2xl"
                  src={about3}
                  alt="About Us"
            ...
            <div className="flex flex-col lg:flex-row gap-6 lg:gap-6 mt-4">
              {/* First image in second line */}
              <div className="w-full lg:w-1/2 mb-4">
                <img
                  className="w-full h-72 object-cover rounded-2xl lg:w-auto lg:h-auto"
                  src={about2}
                  alt="Hands-on experience"
                  loading="lazy" // Lazy loading for this image
                />
              ...
              <div className="w-full lg:w-1/2 mb-4 flex justify-center">
          ...
          {/* Right Column */}
          <div className="lg:w-1/3 w-full p-3 mt-6 lg:mt-0">
