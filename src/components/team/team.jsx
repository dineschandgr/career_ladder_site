...
function Team() {
  ...
  return (
    <div className="pb-0 m-0">
      ...
      <div className="flex justify-center font-medium text-3xl pt-24 text-blue-700 bg-gradient-to-b from-violet-400 to-white h-auto py-12 sm:py-12">
          ...
          {data.map((teamMember, index) => (
            <div key={index} className="flex flex-col items-center snap-center space-y-6 sm:space-y-4 hover:scale-105 transition-all duration-300">
              ...
              <div className="relative h-[300px] w-[300px] sm:h-[250px] sm:w-[250px] mb-6 p-2 bg-gray-100 rounded-lg hover:bg-blue-100 transition-all duration-300">
                <img className="h-full w-full rounded-lg object-cover" src={teamMember.img} alt={teamMember.name} loading="lazy" />
              </div>
      ...
      <div className="flex justify-center mb-10 sm:mb-8">
        {/* First Image */}
        <img className="h-auto w-full object-cover" src={teams} alt="team image 1" loading="lazy" />
      </div>
      <div className="flex justify-center mt-10 sm:mt-8">
        {/* Second Image */}
        <img className="h-auto w-full object-cover" src={teams2} alt="team image 2" loading="lazy" />
      </div>
