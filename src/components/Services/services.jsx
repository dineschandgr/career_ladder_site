...
const services = [
  {
    ...
    buttonLink: '/dgpage', // Adding a buttonLink to this service
  },
  {
    ...
    buttonLink: '/wdpage', // Adding a buttonLink to this service
  },
  {
    title: 'Staffing',
    description:
    ...
    buttonLink: '/staffingpage', // Adding a buttonLink to this service
  },
  {
    ...
    buttonLink: '/gdesignpage', // Adding a buttonLink to this service
  },
  {
    ...
    buttonLink: '/contentpage', // Adding a buttonLink to this service
  },
  {
    title: 'SEO Services',
    description:
    ...
    buttonLink: '/seopage', // Adding a buttonLink to this service
  },
];

const Service = ({ title, description, imageUrl, whatWeDo, realExample, buttonLink }) => {
  return (
    <div className="flex items-center justify-between bg-white p-6 rounded-xl shadow-md mb-8 transform transition-all duration-300 hover:scale-105 hover:shadow-lg hover:shadow-blue-500">
      ...
      <div className="ml-6 w-2/3">
        ...
        <button
          onClick={() => window.location.href = buttonLink} // Use the dynamic buttonLink
        ...
        <div>
          {services.map((service, index) => (
            <Service
              ...
              buttonLink={service.buttonLink} // Passing the dynamic buttonLink here
            />
          ))}
        </div>
      </div>
