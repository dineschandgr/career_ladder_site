...
const courses = [
  {
    title: "Data Science",
    image: "https://assets.techrepublic.com/uploads/2023/12/tr_20231215-what-is-data-science.jpg",  
  ...
  },
  {
    ...
    image: "https://img.freepik.com/free-photo/saas-concept-collage_23-2149399281.jpg?ga=GA1.1.1943424079.1732703638&semt=ais_hybrid", 
  ...
  {
    title: "UI/UX Design",
    image: "https://skipsuniversity.edu.in/wp-content/uploads/2024/05/101_ux_vs_ui_illustration_blog.png", 
    description: "Understand user interface and experience design to create intuitive and user-friendly products.",
    link: "/UU"
  },
  {
    title: "Embedded Systems",
    image: "https://www.velvetech.com/wp-content/uploads/2023/03/types-of-embedded-systems-fb-1024x538.png", 
    description: "Learn the foundations of embedded systems, IoT, and hardware programming.",
    link: "/ES"
  },
  {
    title: "Automation Testing",
    image: "https://axissoftwaredynamics.com/wp-content/uploads/2022/11/1_fJjQOPz-PdJjRqefaBV13Q.jpeg", 
...
const Courses = () => {
  return (
    <div className="font-sans bg-white min-h-screen">
      ...
      <div className="px-6 py-8 mb-6 bg-gray-100">
      ...
      {/* Hero Section */}
      <div className=" px-6 py-16 mb-2">
        <div className="text-center text-black z-10">
          <h1 className="text-4xl lg:text-5xl font-extrabold mb-4">Explore Our Software Courses</h1>
          <h2 className="text-lg lg:text-xl font-medium">Boost your career with the latest technologies and courses</h2>
        </div>
      </div>

      {/* Courses Section */}
      <div className="px-6 py-16">
        <h2 className="text-3xl font-extrabold text-center mb-10">Available Courses</h2>
        ...
        <div className="grid lg:grid-cols-3 sm:grid-cols-1 gap-12">
          {courses.map((course, index) => (
            <div key={index} className="bg-white shadow-lg rounded-lg overflow-hidden transform hover:scale-105 hover:shadow-xl transition-all duration-300">
              ...
              <div className="p-6">
                <h3 className="text-xl font-extrabold text-blue-700 mb-4">{course.title}</h3>
